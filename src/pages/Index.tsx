      ...
      <main>
        ...
        <section id="pricing" className="py-20 lg:py-32 bg-background border-t border-border/40">
          <div className="container mx-auto max-w-5xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-12">Choose the plan that fits your needs. Enjoy background removal for free, or upgrade for more features.</p>
            <div className="flex flex-col md:flex-row justify-center items-stretch gap-6 md:gap-8">
              {/* Free Plan */}
              <div className="glass-effect rounded-2xl p-8 w-full max-w-xs border border-primary/20 flex flex-col h-full min-h-[520px] pt-8">
                ...
                <ul className="text-left text-muted-foreground space-y-2 mb-6 w-full">
                  <li><span className='text-green-500'>✔️</span> 60 removals per month</li>
              ...
              {/* Pro Plan */}
              <div className="glass-effect rounded-2xl p-8 w-full max-w-xs border-2 border-primary flex flex-col h-full min-h-[520px] pt-8 relative shadow-lg scale-105">
                ...
                <div className="flex-grow"></div>
                <button disabled className="gradient-primary text-white px-6 py-3 rounded-lg font-medium opacity-60 cursor-not-allowed w-full mt-auto">Coming Soon</button>
              </div>
              {/* Enterprise Plan */}
              <div className="rounded-2xl p-8 w-full max-w-xs bg-gradient-to-br from-gray-900 to-gray-800 text-white border border-border flex flex-col h-full min-h-[520px] pt-8">
